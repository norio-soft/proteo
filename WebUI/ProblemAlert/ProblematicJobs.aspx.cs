...
{
	/// <summary>
	/// Summary description for ProblematicJobs.
	/// </summary>
	public partial class ProblematicJobs : Orchestrator.Base.BasePage
	{
		...
		private void ProblematicJobs_Init(object sender, EventArgs e)
		{
		...
		{    
			this.Init += new EventHandler(ProblematicJobs_Init);
		}
		#endregion
	}
}
