...
{
    public partial class ListPointsWithUnknownTown : Orchestrator.Base.BasePage
    {
        ...
        protected void rgPoints_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if (e.Item is GridDataItem)
            {
                ...
                if ((dataRow["Latitude"] != DBNull.Value && Convert.ToInt32(dataRow["Latitude"]) != 0)
                    && (dataRow["Longitude"] != DBNull.Value && Convert.ToInt32(dataRow["Longitude"]) != 0)
                    && dataRow["GeofencePointId"] != DBNull.Value
