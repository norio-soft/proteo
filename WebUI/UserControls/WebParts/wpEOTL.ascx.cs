...
namespace Orchestrator.WebUI.WebParts
{
    ...
    public partial class wpEOTL : System.Web.UI.UserControl, IWebPart
    {
        ...
        public wpEOTL()
        {
            this.Title = "Early On-Time and Late";
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            this.DataUrl = string.Format(
                "{0}/api/order/statisticsearlyontimelate?dateFrom={1:s}&dateTo={2:s}",
