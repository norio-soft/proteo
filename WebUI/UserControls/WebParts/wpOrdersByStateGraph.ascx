<%@ Control Language="C#" AutoEventWireup="true" Inherits="Orchestrator.WebUI.WebParts.wpOrdersByStateGraph" Codebehind="wpOrdersByStateGraph.ascx.cs" %>
...
<div id="chartOrdersByState" style="overflow-y: hidden;">
...
<script>
    nv.addGraph(function () {
        ...
        getData.done(function (data) {
            ...
            $('#chartOrdersByState .no-data-message').toggle(!hasData);
            $('#chartOrdersByState svg').toggle(hasData);
            ...
            d3.select('#chartOrdersByState svg').datum(chartData).call(chart);
        });
