<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpDriverIdlingTimeGraph.ascx.cs" Inherits="Orchestrator.WebUI.UserControls.WebParts.FleetMetrik.wpDriverIdlingTimeGraph" %>

<div id="chartDriverIdlingTime" style="overflow-y: hidden;">
...
<script>
    nv.addGraph(function () {
        ...
        getData.done(function (data) {
            ...
            $('#chartDriverIdlingTime .no-data-message').toggle(!hasData);
            $('#chartDriverIdlingTime svg').toggle(hasData);
            ...
            d3.select('#chartDriverIdlingTime svg')
                .datum(formattedData)
                .call(chart);
        });
