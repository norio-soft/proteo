...
{
    public partial class wpDriverIdlingTimeGraph : System.Web.UI.UserControl, IWebPart
    {
        ...
        public wpDriverIdlingTimeGraph()
        {
            timePeriod = new TimePeriods();
            timePeriod.SetWeekDays();
            this.Title = "Worst Driver Idling Time - " + timePeriod.StartDate + " to " + timePeriod.EndDate;
        }

        protected void Page_Load(object sender, EventArgs e)
        {
            this.DataUrl = string.Format("{0}/api/driver/driveridlingtime?dateFrom={1:s}&dateTo={2:s}",
            ...
            this.ReportDriverUrl = string.Format("{0}/Reports/ReportViewer2.aspx?rn=CAN.DriverIdlingTime&FromDate={1:s}&ToDate={2:s}", baseUrl, timePeriod.StartDate, timePeriod.EndDate);
        }
    }
}