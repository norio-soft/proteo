...
{
    public partial class wpDriverMPGGraph : System.Web.UI.UserControl, IWebPart
    {
        ...
        public wpDriverMPGGraph()
        {
            timePeriod = new TimePeriods();
            timePeriod.SetWeekDays();
            this.Title = "Worst Driver MPG - " + timePeriod.StartDate + " to " + timePeriod.EndDate;
        }

        protected void Page_Load(object sender, EventArgs e)
        {
            this.DataUrl = string.Format("{0}/api/driver/driverfuelconsumption?dateFrom={1:s}&dateTo={2:s}",
            ...
            this.ReportDriverUrl = string.Format("{0}/Reports/ReportViewer2.aspx?rn=CAN.DriverFuelConsumption2&FromDate={1:s}&ToDate={2:s}", baseUrl, timePeriod.StartDate, timePeriod.EndDate);
        }
    }
}