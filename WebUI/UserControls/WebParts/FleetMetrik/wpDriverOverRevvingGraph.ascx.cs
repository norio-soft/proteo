...
{
    public partial class wpDriverOverRevvingGraph : System.Web.UI.UserControl, IWebPart
    {
        ...
        public wpDriverOverRevvingGraph()
        {
            timePeriod = new TimePeriods();
            timePeriod.SetWeekDays();
            this.Title = "Worst Driver Over Revving - " + timePeriod.StartDate + " to " + timePeriod.EndDate;
        }

        protected void Page_Load(object sender, EventArgs e)
        {
            this.DataUrl = string.Format("{0}/api/driver/driveroverrevving?dateFrom={1:s}&dateTo={2:s}",
