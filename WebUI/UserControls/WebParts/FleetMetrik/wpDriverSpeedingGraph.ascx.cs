...
{
    public partial class wpDriverSpeedingGraph : System.Web.UI.UserControl, IWebPart
    {
        ...
        public wpDriverSpeedingGraph()
        {
            timePeriod = new TimePeriods();
            timePeriod.SetWeekDays();
            this.Title = "Worst Driver Speeding - " + timePeriod.StartDate + " to " + timePeriod.EndDate;
        }

        protected void Page_Load(object sender, EventArgs e)
        {
            this.DataUrl = string.Format("{0}/api/driver/driverspeeding?dateFrom={1:s}&dateTo={2:s}",
