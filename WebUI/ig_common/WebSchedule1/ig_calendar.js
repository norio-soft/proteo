...
//		this.select(y, m, d, date, false, show ? -3 : -2, null, false);
	...
	this.update = function(p, v, p0)
	{
		...
		var n0 = this.viewState.findNode("CALENDAR");
		if(n0 == null) n0 = this.viewState.addNode("CALENDAR");
		var n = n0;
		if(p == null)
		{
			p = "PostData";
		...
		{
			if((n = n0.findNode("LAYOUT")) == null)
				n = n0.addNode("LAYOUT");
			if(p0 != null){n0 = n; if((n = n.findNode(p0)) == null) n = n0.addNode(p0);}
		}
