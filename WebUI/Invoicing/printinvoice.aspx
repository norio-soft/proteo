<%@ Page language="c#" Inherits="Orchestrator.WebUI.Invoicing.printinvoice" Codebehind="printinvoice.aspx.cs" %>
...
<asp:Label id=lblJobId runat="server" cssclass="confirmation"></asp:Label></TD>
	...
	<FIELDSET><LEGEND><STRONG>Extras to be included on this self-bill 
invoice</STRONG></LEGEND>
...
<asp:CheckBox id=chkIncludePODs runat="server" Text="PODs" AutoPostBack="True"></asp:CheckBox></TD>
  ...
  <TR>
    <TD></TD>
    <TD>
<asp:CheckBox id=chkIncludeReferences runat="server" Text="References" AutoPostBack="True"></asp:CheckBox></TD>
    <TD></TD></TR>
  <TR>
    <TD></TD>
    <TD>
<asp:CheckBox id=chkIncludeDemurrage runat="server" Text="Demurrage Details" AutoPostBack="True"></asp:CheckBox>
<asp:Label id=lblNoDemurrage runat="server" Visible="False">No Demurrage To Be Added For This Invoice</asp:Label></TD>
    <TD>
<asp:RadioButtonList id=rdoDemurrageType runat="server" Visible="False"></asp:RadioButtonList></TD>
    <TD>
<asp:Label id=lblAcceptedDemurrage runat="server" Visible="True"></asp:Label></TD></TR>
  <TR>
    <TD></TD>
    <TD>
<asp:CheckBox id=chkJobDetails runat="server" Text="Job Details" AutoPostBack="True" Checked="True"></asp:CheckBox></TD>
    <TD></TD></TR>
  <TR>
    <TD></TD>
    <TD>
<asp:CheckBox id=chkExtraDetails runat="server" Text="Extra Details" AutoPostBack="True" Visible="False"></asp:CheckBox>
    <TD></TD></TR>
  <TR>
    <TD height=60></TD>
    <TD vAlign=top height=60>
<asp:CheckBox id=chkIncludeFuelSurcharge runat="server" Text="Fuel Surcharge" AutoPostBack="True"></asp:CheckBox>
      <DIV id=divFuelSurcharge runat="server" Visible="False">
<asp:TextBox id=txtFuelSurchargeRate runat="server"></asp:TextBox>% 
<asp:RangeValidator id=rfvFuelSurchargeRate runat="server" Display="Dynamic" ControlToValidate="txtFuelSurchargeRate" ErrorMessage="Please enter a valid higher than 0% and less than 100%." EnableClientScript="True" Type="Double" MaximumValue="100" MinimumValue="0.1"><img src="../images/Error.gif" height="16" width="16" title="Please enter a valid higher than 0% and less than 100%."/></asp:RangeValidator>
<asp:requiredfieldvalidator id=rfvFuelSurhargeRateRequired runat="server" Display="Dynamic" ControlToValidate="txtFuelSurchargeRate" ErrorMessage="Please enter a fuel surcharge amount." EnableClientScript="True"><img src="../images/Error.gif" height="16" width="16" title="Please enter a fuel surcharge amount." /></asp:requiredfieldvalidator></DIV></TD>
    <TD height=60>
<asp:RadioButtonList id=rdoFuelSurchargeType runat="server" Visible="false"></asp:RadioButtonList></TD></TR></TABLE>
		</asp:panel>
	</FIELDSET>
	<!-- Sort Section -->
	<FIELDSET>
