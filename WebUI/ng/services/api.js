...
angular.module('peApp').factory('apiService', ['$resource', '$rootScope', function ($resource, $rootScope) {
    var service = {};
    ...
    service.scheduleResource = $resource(url('scheduleresource'), null, {
        getResourceTypes: {
            method: 'GET',
            url: url('scheduleresource/resourcetypes'),
            isArray: true
        },
        getDriverTypes: {
            method: 'GET',
            url: url('scheduleresource/drivertypes'),
            isArray: true
        },
        getDepots: {
            method: 'GET',
            url: url('scheduleresource/depots'),
            isArray: true
        },
        getActivityTypes: {
            method: 'GET',
            url: url('scheduleresource/activitytypes'),
            isArray: true,
            params: { resourceTypeId: '@resourceTypeId' }
        },
        getResources: {
            method: 'GET',
            url: url('scheduleresource/resources'),
            isArray: true,
            params: { resourceTypeId: '@resourceTypeId', showUnavailable: '@showUnavailable' }
        },
        getResourceSchedule: {
            method: 'GET',
            url: url('scheduleresource/resourceschedule'),
            isArray: true,
            params: {
            ...
            transformResponse: function (data, header) {
                ...
                if (angular.isArray(deserialized)) {
                    angular.forEach(deserialized, function (item, idx) {
                        item.start_date = moment(item.start_date).format('MM/DD/YYYY HH:mm');
                        item.end_date = moment(item.end_date).format('MM/DD/YYYY HH:mm');
                    });
                }
                return deserialized;
            }
        ...
        createResourceSchedule: {
            ...
            url: url('scheduleresource/resourceschedule'),
            isArray: false,
            params: { resourceSchedule: '@resourceSchedule' }
        },
        ...
        deleteResourceSchedule: {
            method: 'DELETE',
            url: url('scheduleresource/resourceschedule/:id')
        }        
    });
