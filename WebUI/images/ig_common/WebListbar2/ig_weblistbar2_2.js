...
function UltraWebListbar(id,groups){
	...
	while(groups[i]!=null){
		...
		groups[i].i = i;//must be permanent
...
function iglbar_Item(id,text,key,defStyle,hovStyle,selStyle,targetUrl,targetFrame,image,selectedImage,enabled){
	this.Id=id;
	this.Element=ig_csom.getElementById(id);
	this.getText=function(){return iglbar_getInnerText(ig_csom.getElementById(this.Id));}
	this.setText=function(text)
	{
		iglbar_setInnerText(ig_csom.getElementById(this.Id),text);
		this.Group.Control.update(this.Group, this, "Text", text);
	}
	this.Key=key;
...
function iglbar_getGroupText(){
	if(this.HeaderAppearance)
		return iglbar_getInnerText(ig_csom.getElementById(this.Id+"_text"));
	else
		return iglbar_getInnerText(ig_csom.getElementById(this.Id+"_text_top"));
}
function iglbar_setGroupText(text){
	if(this.HeaderAppearance){
		iglbar_setInnerText(ig_csom.getElementById(this.Id+"_text"),text);
	}else
	{
		var buttonTop=ig_csom.getElementById(this.Id+"_text_top");
		var buttonBot=ig_csom.getElementById(this.Id+"_text_bottom");
		iglbar_setInnerText(buttonTop,text);
		iglbar_setInnerText(buttonBot,text);
	}
	this.Control.update(this, null, "Text", text);
}
