...
function igtab_getTabById(id)
{
	var o = igtab_all[id];
	if(o != null) return o;
	for(var i in igtab_all) if((o = igtab_all[i]) != null) if(o.ID == id || o.uniqueId == id) return o;
	return null;
}
// public:
...
function igtab_event(e)
{
	...
	if(e.type == "click" || e.type == "mousedown") type = 2;
	if(e.type == "mouseup") type = 4;
	o = igtab_getTabFromElement(o);
	if(o == null || (type == 2 && (e.button > 1 || e.ctrlKey || e.shiftKey || e.altKey))) return;
	...
	this.setState = function(st, e)
	{
		...
		if(st == 2)
		{
			if(e != null)
			{
				...
				if(o.doPost) try{o.update(-1, "SelectedTab", this.index + 10000); __doPostBack(o.uniqueId, "" + this.index); return;}catch(ex){}
			}
