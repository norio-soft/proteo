<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/default_tableless.Master"  CodeBehind="SafetyCheckProfiles2.aspx.cs" Inherits="Orchestrator.WebUI.Resource.SafetyChecks.Profiles2" %>
        ...
        <telerik:RadPageView id="rpProfileList" runat="server">
            ...
            <telerik:RadGrid runat="server" ID="rgProfiles" AutoGenerateColumns="false" AllowSorting="false">
                <MasterTableView DataKeyNames="ID">
                    <Columns>
                        <telerik:GridBoundColumn DataField="Title" HeaderText="Safety Check Profile Name" HeaderStyle-Width="65%" />
                        <telerik:GridBoundColumn DataField="VehicleList.Count" HeaderText="Number of Assigned Vehicles" HeaderStyle-Width="20%" />
                                        ...
                                        <tr>
                                            <td class="faultActionCol">
                                                <asp:ImageButton ID="imgBtnUp" runat="server" ImageUrl="/App_Themes/Orchestrator/img/masterpage/icon-arrow-up.png"
                                                    CausesValidation="false" CommandArgument='<%# ((Fleetwood.BlueSphere.BusinessLogic.FaultType)Container.DataItem).ID %>' 
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" id="txtFaultTitle" CssClass="faultTextBox" Text="<%# ((Fleetwood.BlueSphere.BusinessLogic.FaultType)Container.DataItem).Title %>" ToolTip="Title"></asp:TextBox>
                                            ...
                                            <td style="display:none;"><%-- This is set to display none because spec doesnt accoutn for it but I have a feeling it will be needed --%>
                                                <asp:TextBox runat="server" id="txtFaultCategory" CssClass="faultTextBox" Text="<%# ((Fleetwood.BlueSphere.BusinessLogic.FaultType)Container.DataItem).FaultCategory %>" ToolTip="Category"></asp:TextBox>
                                            ...
                                            <td class="faultToggleCol">
                                                <asp:CheckBox runat="server" id="chkIsDiscretionary" CausesValidation="False" ToolTip="Should the fault allow discretionary passes?" Checked="<%# ((Fleetwood.BlueSphere.BusinessLogic.FaultType)Container.DataItem).IsDiscretionaryQuestion %>"/>
                                            </td>
                                            <td style="display:none;" class="faultToggleCol">
                                                <asp:CheckBox runat="server" id="chkHighlight" CausesValidation="False" ToolTip="Highlight?" Checked="<%# ((Fleetwood.BlueSphere.BusinessLogic.FaultType)Container.DataItem).Highlight %>"/>
                                            </td>
                                            <td class="faultActionCol">
                        ...
                        <table class="profileAssignmentTable">
                            <tr>
                                ...
                                <td style="min-width: 400px">
                                    <asp:CheckBox ID="chkShowAllVehicles" runat="server" AutoPostBack="true" Text="Also include Vehicles which are assigned to other Profiles (*)" />
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align:center; font-weight:bold">
                                    Assigned Vehicles [<asp:Label ID="lblAssignedCount" runat="server"></asp:Label>]
                                </td>
                                <td style="text-align:center; font-weight:bold">
                                    Unassigned Vehicles [<asp:Label id="lblUnassignedCount" runat="server"></asp:Label>]
                                </td>
                            </tr>
                            <tr>
                                <td>
