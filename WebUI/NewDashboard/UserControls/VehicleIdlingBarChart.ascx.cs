...
{
    public partial class VehicleIdlingBarChart : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.Attributes["mode"] != null)
            {
                ...
                idlingTimeList = canDasboardServices.GetVehicleIdlingTime(timePeriod.StartDate, timePeriod.EndDate, null);
                idlingTimeList.Sort(delegate(IdlingTime it1, IdlingTime it2) { return it2.Percentage.CompareTo(it1.Percentage); });
