<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VehicleIdlingTimeBarChart.ascx.cs" Inherits="Orchestrator.WebUI.NewDashboard.UserControls.VehicleIdlingTimeBarChart" %>
...
$(function() {
      ...
      var chart = new Highcharts.Chart({
            chart: {
                renderTo: 'VehicleIdlingTimeBarChart',
                type: 'bar',
                marginRight: 30,
                marginBottom: 70
            },
