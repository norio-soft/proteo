<%@ Page Language="C#" MasterPageFile="~/WizardMasterPage.master" AutoEventWireup="true" Inherits="Orchestrator.WebUI.Groupage.AssociateOrderWithGroup" Title="Haulier Enterprise" Codebehind="AssociateOrderWithGroup.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!--
        ...
        function ChangeList(e, src, orderID, noPallets, orderGroupId)
        {
            var gridRow;
            ...
            else
            {
                ...
                orderGroups = orderGroups.replace(orderGroupId + ",", "");
                orderGroups = orderGroups.replace("," + orderGroupId, "");
                orderGroups = orderGroups.replace(orderGroupId, "");
        ...
        function HasAnOrderOnAGroupBeenSelected()
        {
            var groupedOrderSelected = true;
            if(orderGroups != "") 
            {
                if (!confirm('One or more orders have been selected that are already on a group. If you continue the orders will be removed from their group and added to this one. Would you like to continue?'))
                {
                    groupedOrderSelected = false;
                }
            }
            
            return groupedOrderSelected;
        }
    ...
    <fieldset style="padding:0px;margin-top:5px; margin-bottom:5px;">
        ...
        <p style="font-size:12px">Use this screen to find orders in the system, then select the orders you wish to associate with this group.</p>
    ...
    <div class="buttonBar">            
        ...
        <asp:Button ID="btnAssociate" runat="server" Text="Associate" Width="75" OnClientClick="return HasAnOrderOnAGroupBeenSelected(); " />
    </div>     
