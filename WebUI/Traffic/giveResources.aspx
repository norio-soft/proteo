<%@ Page Language="C#" AutoEventWireup="true" Inherits="Orchestrator.WebUI.Traffic.giveResources" Codebehind="giveResources.aspx.cs" %>
                            ...
                            <td class="greyText" width="100%" valign="top">
                                <div style="height: 220px; width: 100%; overflow: auto;">
                                    <table height="120" border="0">
                                        ...
                                        <tr valign=top>
                                            <td colspan="2">This will give the resources to the new planner.</td>
                                        </tr>
                                        <tr valign="top">
                                            <td width="50%"><b>Resources Affected</b></td>
                                            <td width="50%"><b>Planner</b></td>
                                        </tr>
                                        <tr valign="top">
                                            <td>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="cboControlArea" runat="server" DataValueField="ControlAreaId" DataTextField="Description"></asp:DropDownList>
