<%@ Page MasterPageFile="~/default_tableless.master" Language="C#" AutoEventWireup="true" CodeBehind="ResourceManifest.aspx.cs" Inherits="Orchestrator.WebUI.manifest.ResourceManifest" %>
...
<asp:Content ContentPlaceHolderID="HeaderPlaceHolder1" runat="server"><h1>Resource Manifest</h1></asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="buttonBar">
        ...
        <input type="button" value="Create a New Manifest" onclick="javascript:window.location = 'ResourceManifestBuilder.aspx';" />
    </div>
    ...
    <asp:Panel runat="server" ID="pnlExistingManifest">
        ...
        <legend>Options</legend>
            <table>
                <tr>
                    <td>
                        Add additional blank rows:&nbsp;<telerik:RadNumericTextBox runat="server" ID="txtExtraRowCount" MinValue="0" MaxValue="20" Width="40px" NumberFormat-DecimalDigits="0" />
                    </td>
                    <td>
        ...
        <div class="buttonBar">
            ...
            <asp:Button runat="server" ID="btnAddJobsToManifest" Text="Add Jobs To Driver Manifest" />
        </div>
    </asp:Panel>
