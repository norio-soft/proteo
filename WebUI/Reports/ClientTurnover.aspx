<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientTurnover.aspx.cs" Inherits="Orchestrator.WebUI.Reports.ClientTurnover" MasterPageFile="~/default_tableless.master" Title="Client Turnover Per Month" %>

<asp:Content ContentPlaceHolderID="HeaderPlaceHolder1" runat="server"><h1>Client Turnover per Month</h1></asp:Content>
...
<script language="javascript" type="text/javascript">
    ...
    <h2>Use this screen to retrieve a report showing client turnover per month for the specified date range.</h2>
    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td>&nbsp;</td>
                <td class="formCellInput">
                    <asp:CheckBox ID="chkIncludeTotalsPerClient" runat="server" Text="Include Client Totals" Checked="true" />
