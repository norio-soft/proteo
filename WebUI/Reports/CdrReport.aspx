<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CdrReport.aspx.cs" Inherits="Orchestrator.WebUI.Reports.CdrReport" MasterPageFile="~/default_tableless.master" %>
                    ...
                    <td runat="server" id="tdDateOptions">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="formCellField">
                                    <telerik:RadDatePicker ID="dteEndDate" runat="server" ToolTip="The Start Date for the filter">
                                    <DateInput runat="server"
                                    DateFormat="dd/MM/yy">
                                    </DateInput>
                                    </telerik:RadDatePicker>
